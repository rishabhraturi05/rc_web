...
export default function EmergencyButton({ onClick, disabled = false, label = "EMERGENCY\nMEETING" }) {
  return (
    <div className="relative flex flex-col items-center justify-center p-4 font-vcr">
      <div className="emergency-button-container">
        <button
          ...
          disabled={disabled}
          onClick={onClick}
          className={`emergency-btn-3d-active emergency-pulse-glow group ${
            disabled ? "opacity-50 cursor-not-allowed" : "cursor-pointer"
          }`}
          aria-label="Trigger Emergency Meeting Registration"
        >
